...
public class CBSSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	 ...
	 *
	 * Constraint:
	 *     (container=[Container|QualifiedName] allocates=[AssemblyContext|QualifiedName])
	 * </pre>
	 */
	protected void sequence_AllocationContext(ISerializationContext context, AllocationContext semanticObject) {
		...
		feeder.accept(grammarAccess.getAllocationContextAccess().getContainerContainerQualifiedNameParserRuleCall_2_0_1(), semanticObject.eGet(AllocationPackage.Literals.ALLOCATION_CONTEXT__CONTAINER, false));
		feeder.accept(grammarAccess.getAllocationContextAccess().getAllocatesAssemblyContextQualifiedNameParserRuleCall_4_0_1(), semanticObject.eGet(AllocationPackage.Literals.ALLOCATION_CONTEXT__ALLOCATES, false));
		feeder.finish();
	}
	 ...
	 *
	 * Constraint:
	 *     (environment=[Environment|QualifiedName] (allocationContexts+=AllocationContext allocationContexts+=AllocationContext*)?)
	 * </pre>
	 */
	 ...
	 *
	 * Constraint:
	 *     (requiringRole=[RequiredRole|QualifiedName] providingRole=[ProvidedRole|QualifiedName])
	 * </pre>
	 */
	protected void sequence_AssemblyConnector(ISerializationContext context, AssemblyConnector semanticObject) {
		...
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getAssemblyConnectorAccess().getRequiringRoleRequiredRoleQualifiedNameParserRuleCall_1_0_1(), semanticObject.eGet(AssemblyPackage.Literals.ASSEMBLY_CONNECTOR__REQUIRING_ROLE, false));
		feeder.accept(grammarAccess.getAssemblyConnectorAccess().getProvidingRoleProvidedRoleQualifiedNameParserRuleCall_3_0_1(), semanticObject.eGet(AssemblyPackage.Literals.ASSEMBLY_CONNECTOR__PROVIDING_ROLE, false));
		feeder.finish();
	}
	 ...
	 *     (
	 *         name=EString 
	 *         instantiates=[Component|QualifiedName] 
	 ...
	 *     (
	 *         name=EString 
	 *         (provides+=[Interface|QualifiedName] provides+=[Interface|QualifiedName]*)? 
	 *         (requires+=[Interface|QualifiedName] requires+=[Interface|QualifiedName]*)? 
	 ...
	 *
	 * Constraint:
	 *     (type=CollectionTypeEnum innerType=[ParameterType|QualifiedName] name=EString)
	 * </pre>
	 */
	protected void sequence_CollectionType(ISerializationContext context, CollectionType semanticObject) {
		...
		feeder.accept(grammarAccess.getCollectionTypeAccess().getInnerTypeParameterTypeQualifiedNameParserRuleCall_2_0_1(), semanticObject.eGet(TypesPackage.Literals.COLLECTION_TYPE__INNER_TYPE, false));
	 ...
	 *
	 * Constraint:
	 *     (name=EString type=[ParameterType|QualifiedName])
	 * </pre>
	 */
	protected void sequence_ComplexMember(ISerializationContext context, ComplexMember semanticObject) {
		...
		feeder.accept(grammarAccess.getComplexMemberAccess().getTypeParameterTypeQualifiedNameParserRuleCall_2_0_1(), semanticObject.eGet(TypesPackage.Literals.COMPLEX_MEMBER__TYPE, false));
		feeder.finish();
	}
	 ...
	 *
	 * Constraint:
	 *     requiredService=[Signature|QualifiedName]
	 * </pre>
	 */
	protected void sequence_ExternalCallAction(ISerializationContext context, ExternalCallAction semanticObject) {
		...
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getExternalCallActionAccess().getRequiredServiceSignatureQualifiedNameParserRuleCall_1_0_1(), semanticObject.eGet(BehavioraldescriptionPackage.Literals.EXTERNAL_CALL_ACTION__REQUIRED_SERVICE, false));
		feeder.finish();
	}
	 ...
	 *
	 * Constraint:
	 *     (links+=[Container|QualifiedName] links+=[Container|QualifiedName]*)
	 * </pre>
	 */
	 ...
	 *
	 * Constraint:
	 *     (type=[ParameterType|QualifiedName] name=EString)
	 * </pre>
	 */
	protected void sequence_Parameter(ISerializationContext context, componentbasedsystem.repository.Parameter semanticObject) {
		...
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getParameterAccess().getTypeParameterTypeQualifiedNameParserRuleCall_0_0_1(), semanticObject.eGet(RepositoryPackage.Literals.PARAMETER__TYPE, false));
	 ...
	 *
	 * Constraint:
	 *     providingRole=[ProvidedRole|QualifiedName]
	 * </pre>
	 */
	protected void sequence_ProvidedDelegationConnector(ISerializationContext context, ProvidedDelegationConnector semanticObject) {
		...
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getProvidedDelegationConnectorAccess().getProvidingRoleProvidedRoleQualifiedNameParserRuleCall_0_1(), semanticObject.eGet(AssemblyPackage.Literals.PROVIDED_DELEGATION_CONNECTOR__PROVIDING_ROLE, false));
		feeder.finish();
	}
	 ...
	 *
	 * Constraint:
	 *     (name=EString interface=[Interface|QualifiedName])
	 * </pre>
	 */
	protected void sequence_ProvidedRole(ISerializationContext context, ProvidedRole semanticObject) {
		...
		feeder.accept(grammarAccess.getProvidedRoleAccess().getInterfaceInterfaceQualifiedNameParserRuleCall_1_0_1(), semanticObject.eGet(AssemblyPackage.Literals.PROVIDED_ROLE__INTERFACE, false));
		feeder.finish();
	}
	 ...
	 *
	 * Constraint:
	 *     requiringRole=[RequiredRole|QualifiedName]
	 * </pre>
	 */
	protected void sequence_RequiredDelegationConnector(ISerializationContext context, RequiredDelegationConnector semanticObject) {
		...
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getRequiredDelegationConnectorAccess().getRequiringRoleRequiredRoleQualifiedNameParserRuleCall_0_1(), semanticObject.eGet(AssemblyPackage.Literals.REQUIRED_DELEGATION_CONNECTOR__REQUIRING_ROLE, false));
		feeder.finish();
	}
	...
	protected void sequence_RequiredRole(ISerializationContext context, RequiredRole semanticObject) {
		...
		feeder.accept(grammarAccess.getRequiredRoleAccess().getInterfaceInterfaceQualifiedNameParserRuleCall_1_0_1(), semanticObject.eGet(AssemblyPackage.Literals.REQUIRED_ROLE__INTERFACE, false));
		feeder.finish();
	}
	 ...
	 *
	 * Constraint:
	 *     (implements=[Signature|QualifiedName] actions+=AbstractAction actions+=AbstractAction*)
	 * </pre>
	 */
	 ...
	 *
	 * Constraint:
	 *     (returnType=[Type|QualifiedName] name=EString (parameters+=Parameter parameters+=Parameter*)?)
	 * </pre>
	 */
