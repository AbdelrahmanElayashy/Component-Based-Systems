...
public class CBSGenerator extends AbstractGenerator {
  ...
  public void doGenerate(final Resource resource, final IFileSystemAccess2 fsa, final IGeneratorContext context) {
    ...
    Iterable<AtomicComponent> _filter_2 = Iterables.<AtomicComponent>filter(IteratorExtensions.<EObject>toIterable(resource.getAllContents()), AtomicComponent.class);
    for (final AtomicComponent atomicComponent : _filter_2) {
      String _name = atomicComponent.getName();
      String _plus_2 = ("repository/" + _name);
      String _plus_3 = (_plus_2 + "/");
      String _name_1 = atomicComponent.getName();
      String _plus_4 = (_plus_3 + _name_1);
      String _plus_5 = (_plus_4 + "Impl.java");
      fsa.generateFile(_plus_5, 
        this.compile(atomicComponent));
    }
  }
